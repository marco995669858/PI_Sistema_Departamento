...
function validarPerfil() {
	...
	var nuevacontraseña = document.getElementById("idPassword").value;
	...
	if (!nombreUsuario || !nombre || !apellidoPaterno || !apellidoMaterno || !correo || !contraseña || !nuevacontraseña) {
	...
	} else if (nuevacontraseña.length < 9 || nuevacontraseña.length > 9) {
		mensaje('La contraseña no es igual.');
		return false;
